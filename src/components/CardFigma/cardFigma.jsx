...
export default function CardFigma({ title: initialTitle }) {
    ...
    return (
        <cardFigma>
        <div style={{width: '350', height: '175', background: 'white', boxShadow: '2px 2px 4px 2px rgba(0, 0, 0, 0.15)', borderRadius: 25, overflow: 'hidden', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
            ...
            <div style={{alignSelf: 'stretch', height: 175, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
                <img style={{width: 350, height: 175, position: 'relative'}} src="https://via.placeholder.com/350x175" />
            </div>
